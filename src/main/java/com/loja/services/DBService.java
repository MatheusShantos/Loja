...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat7 = new Categoria(null, "Pefumaria");
		...
		Cidade c1 = new Cidade(null, "Lajedo", est1);
		Cidade c2 = new Cidade(null, "Acari", est2);
		Cidade c3 = new Cidade(null, "Garanhuns", est1);
		...
		Cliente cli1 = new Cliente(null, "Matheus Santos", "matheus@gmail.com", "11111111111",
				TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("123456789", "213465789"));

		Endereco e1 = new Endereco(null, "Rua Major Captú", "19", "Em frente ao CRAS", "Sem bairro", "55385000", cli1,
				c1);
		Endereco e2 = new Endereco(null, "Sítio Capoeiras", "00", "Em frente a vaquejada", "Sem bairro", "55385000",
				cli1, c1);

		cli1.getEnderecos().addAll(Arrays.asList(e1, e2));

		Cliente cli2 = new Cliente(null, "Rafael Silva", "rafael@gmail.com", "22222222222", TipoCliente.PESSOAFISICA);
		cli2.getTelefones().addAll(Arrays.asList("987654321"));

		Endereco e3 = new Endereco(null, "Av Brasil", "15", "Em frente ao Mercadinho Santo Antônio", "Sem bairro",
				"55832000", cli2, c3);
